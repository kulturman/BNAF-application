(function ($, DataTable) {
    ...
    DataTable.ext.buttons.export = {
        ...
        text: function (dt) {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', 'Exporter') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', 'Réinitialiser');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: function (dt) {
            return '<i class="fa fa-refresh"></i> ' + dt.i18n('buttons.reload', 'Recharger');
        },
    ...
    DataTable.ext.buttons.create = {
        ...
        text: function (dt) {
            return '<i class="fa fa-plus"></i> ' + dt.i18n('buttons.create', 'Créer');
        },
