<div class='btn-group'>
    <a data-message="Voulez vous valider cette alerte" data-method="POST" title="Valider"
       href="{{ route('reports.validate', $id) }}" class='ajax-button btn btn-ghost-success'>
