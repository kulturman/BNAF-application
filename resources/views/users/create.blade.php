        ...
        <div class="mb-4">
            <div>
                <div class="rounded-bottom">
                    {!! Form::open(['id' => 'usersCreateForm', 'route' => 'users.store', 'class' => 'row g-3
                    main-form']) !!}
                    @include('users.fields')
                    <div class="form-group col-sm-6">
                        {!! Form::label('password', 'Mot de passe:') !!}
                        {!! Form::password('password', ['class' => 'form-control','maxlength' => 255,'maxlength' =>
                        255]) !!}
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::password('password_confirmation', ['class' => 'form-control','maxlength' =>
                        255,'maxlength' => 255]) !!}
                        <strong class="form-error-message"></strong>
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::text('agent_code', null, ['class' => 'form-control','maxlength' => 255,'maxlength' =>
                        255]) !!}
                        <strong class="form-error-message"></strong>
                    </div>
