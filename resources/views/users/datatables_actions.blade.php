<div class='btn-group'>
    ...
    <a title="Réinitiliaser le mot de passe" class="btn btn ajax-confirmation-button"
       data-tooltip="Réinitialiser mot de passe" href="{{ route('users.reset-password', $id) }}">
